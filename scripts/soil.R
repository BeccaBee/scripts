...
ggplot(soil,
  aes(geom_point(x=soil$UTM_north, y=soil$Omloi, color=soil$block), geom_smooth()))   

OM3<-gam(Omloi ~ s(UTM_north) + (1|block) data = soil)
summary(OM3)
pdf(summary(OM3), file = "~/PRP_thesis/Data/Graphs.pdf")
